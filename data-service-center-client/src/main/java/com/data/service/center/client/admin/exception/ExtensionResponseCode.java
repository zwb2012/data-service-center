 ...
 * Description: 自定义响应码样例  <br/>
 *
 * @author wenbo.zhuang
 */
public class ExtensionResponseCode extends DefaultResponseCode {
    ...
    public ExtensionResponseCode(String code, String msg, String userMsg) {
